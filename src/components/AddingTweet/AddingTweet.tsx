...
import styles from './AddingTweet.module.scss'
...
// import gifIcon from "@iconify/icons-simple-icons/gif";
interface Props {
    setTweets: Dispatch<SetStateAction<Tweet[]>>
}

export const AddingTweet = ({ setTweets }: Props) => {
    //refs
    ...
    return (
        <div className={styles.addingTweetContiner}>
